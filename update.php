...
$sql = " UPDATE 'registrition' SET 'Fname'='$value1','Lname'='$value2','Adress'='$value3','Date'='$value4',
'Pwork'='$value5',
'Design'='$value6',
'Location'='$value7',
'Particular'='$value8',
...
if(isset($_GET['SN'])){
    $value = $_GET['SN'];
    $sql = "SELECT *FROM 'registrition' WHERE 'SN' = '$value'";
    ...
    if($result->num_rows > 0){
        while($row = $result->fetch_assoc()){
            $value1 = $row['Fname'];
            $value2 = $row['Lasttname'];
            $value3 = $row['Adress'];
            $value4 = $row['Date'];
            $value5 = $row['PlaceofWork'];
            $value6 = $row['Designation'];
            $value7 = $row['Location']; 
			$value8 = $row['Particular'];
            $value9 = $row['Cashbefore'];
            $value10 = $row['Currentcash'];
            $value11 = $row['Bankname'];
            $value12 = $row['Balance'];
			$value13 = $row['Amount']; 
			$value = $row['SN']; 
    ...
    <body>
        ...
        <div class="profile">
            <div class="marg">
            <form class="form_reg"action="search.php" method="post">
       ...
       <button onClick="update.html" class="Home1">Search</button><br><br>
           ...
           <form action ="update.php" method="post">
		    <input placeholder="First Name" name="Firstname" value="<?php echo $value1 ?>" class="File" type="text">
            ...
            <button name="update" type="submit" value="update" class="Home1">Update Record</button><button name="delete" class="Home1">Delete Record</button><button onClick="window.location.href='./Search.html'" class="Home1">Close</button>
        </form>
		</div>
		</div>
		</body>
